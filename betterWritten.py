...
def perform_mc_sim(mc_sims, T, covMatrix, weights, meanReturns, initialPortfolio):
    epsilon = 1e-10
    while True:
        try:
...
def visualize_sims(portfolio_sims, initialPortfolio, mc_sims, median_return, VaR, CVaR, historical_data):
...
def main():
    ...
    portfolio_sims = perform_mc_sim(mc_sims, T, covMatrix, weights, meanReturns, initialPortfolio)
    ...
    visualize_sims(portfolio_sims, initialPortfolio, mc_sims, median_return, VaR, CVaR, historical_data)
